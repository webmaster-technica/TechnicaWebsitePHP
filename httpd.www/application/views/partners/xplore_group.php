        ...
        <div class="grid">
            <div class="col-3 mcol-1">
                ...
                <div class="sponsor-contact">
                    ...
                    <span class="sponsor-contact-txt selectable"><a href="mailto:info@xploregroup.be">info@xploregroup.be</a></span>
                </div>
                <div class="sponsor-contact">
                    <span class="fa-stack fa-lg">
                        <i class="fa fa-circle fa-stack-2x"></i>
                    ...
                    <span class="sponsor-contact-txt selectable"><a href="tel:+3238719966">+32 3 871 99 66</a></span>
                </div>
                <div class="sponsor-contact">
                    <span class="fa-stack fa-lg">
                        <i class="fa fa-circle fa-stack-2x"></i>
                    ...
                    <span class="sponsor-contact-txt selectable"><a href="https://www.xploregroup.be" target="_blank">www.xploregroup.be</a></span>
                </div>
            </div>
