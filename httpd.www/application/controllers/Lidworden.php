            ...
            */
            ...
            if ($_POST) {
                if(!empty($_POST['robotest'])){
                    ...
                    $sql = "INSERT INTO `Leden`(`Naam`, `Geboortedatum`, `Richting`, `Jaar`, `Email`, `Gsm`, `Straat`, `Huisnr`, `Stad`, `Postcode`, `Dopen`, `Foto`) VALUES ('{$_POST['name']}','{$_POST['birth_date']}','{$_POST['study']}','{$_POST['study_year']}','{$_POST['email']}','{$_POST['gsm']}','{$_POST['street']}','{$_POST['house_number']}','{$_POST['city']}','{$_POST['postal']}','{$_POST['dopen']}','$imageData')";
